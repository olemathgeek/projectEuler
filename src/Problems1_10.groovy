...
//        What is the smallest positive number that is evenly divisible by all of the numbers from 1 to 20?
    ...
    public static void problem8old(){
    ...
    public static void problem8(){
        ...
        for(int i=0; i<num.length()-13; i++){
            long a = Integer.valueOf(num.substring(i,i+1))
            long b = Integer.valueOf(num.substring(i+1,i+2))
            long c = Integer.valueOf(num.substring(i+2,i+3))
            long d = Integer.valueOf(num.substring(i+3,i+4))
            long e = Integer.valueOf(num.substring(i+4,i+5))
            long f = Integer.valueOf(num.substring(i+5,i+6))
            long g = Integer.valueOf(num.substring(i+6,i+7))
            long h = Integer.valueOf(num.substring(i+7,i+8))
            long ii = Integer.valueOf(num.substring(i+8,i+9))
            long j = Integer.valueOf(num.substring(i+9,i+10))
            long k = Integer.valueOf(num.substring(i+10,i+11))
            long l = Integer.valueOf(num.substring(i+11,i+12))
            long m = Integer.valueOf(num.substring(i+12,i+13))
            long prod = a*b*c*d*e*f*g*h*ii*j*k*l*m
            if(prod > largestProd){
                largestProd = prod
            }
        }
